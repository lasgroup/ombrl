...
class ContinualMaxInfoLearner(object):
    def __init__(self,
        ...
        self.policy_perturb_rate = policy_perturb_rate
        self.critic_perturb_rate = critic_perturb_rate
        self.model_perturb_rate = model_perturb_rate
        self.policy_reset_period = policy_reset_period
        self.critic_reset_period = critic_reset_period
        self.model_reset_period = model_reset_period
        ...
        self.policy_perturb_module = PolicyPerturbationModule(
            ...
            perturb_rate=self.policy_perturb_rate,
            perturbation_freq=self.policy_reset_period,
            perturb_policy=self.perturb_policy,
        )
        ...
        self.critic_perturb_module = CriticPerturbationModule(
            ...
            perturb_rate=self.critic_perturb_rate,
            perturbation_freq=self.critic_reset_period,
            perturb_critic=self.perturb_critic,
        )

        self.model_perturb_module = ModelPerturbationModule(
            model_init_fn=ensemble.init,
            perturb_rate=self.model_perturb_rate,
            perturbation_freq=self.model_reset_period,
            perturb_model=self.perturb_model,
        )
        ...
        self.step = 1
        self._last_perturbed_episode = -1
        if dt is not None:
    ...
    def update(self, batch: Batch, episode_idx: int = None) -> InfoDict:
        if self._reset_models and episode_idx != self._last_perturbed_episode:
            ...
            self.actor, self.target_actor = self.policy_perturb_module.perturb(
                actor=self.actor,
            ...
            self.critic, self.target_critic = self.critic_perturb_module.perturb(
                critic=self.critic,
            ...
            self.ens_state = self.model_perturb_module.perturb(
