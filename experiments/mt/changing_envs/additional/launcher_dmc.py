...
PROJECT_NAME = 'MT_Jan_20_17_30_Dmc_Test_1'
WANDB_OFFLINE = True
...
all_flags_combinations = dict_permutations(configs_cartpole | _applicable_configs_continual_mean)\
    + dict_permutations(configs_others | _applicable_configs_continual_mean)\
