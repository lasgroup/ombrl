...
PROJECT_NAME = 'MT_Jan_21_23_50_Gym_walker2d_Test_1'
WANDB_OFFLINE = True
...
_applicable_configs = {
    ...
    'pseudo_ct': [0],
    'predict_diff': [1],
    'parameter_decay': [0.0, 0.0005, 0.002, 0.005],
    'reset_models': [1],
    'save_video': [0],
    'eval_episodes': [5],
}
...
_applicable_configs_continual = {'alg_name': ['continualmaxinfo'],
                             ...
                             'replay_buffer_size': [1_200_000], # TODO ablate
                             ...
                             'policy_reset_period': [1200], # TODO ablate
                             'critic_reset_period': [1200], # TODO ablate
                             'model_reset_period': [1200], # TODO ablate
                            } | _applicable_configs
...
all_flags_walker = (
  ...
  + dict_permutations(configs_walker | _applicable_configs_continual)
)

all_flags_combinations = all_flags_walker
