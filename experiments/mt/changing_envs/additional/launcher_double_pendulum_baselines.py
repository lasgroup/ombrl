...
PROJECT_NAME = 'MT_Mar_13_16_16_Gym_invertedDoublePendulum_regret_baseline_1'
...
_applicable_configs = {
    ...
    'predict_diff': [1],
    'parameter_decay': [0.0],
    'fixed_parameter': np.linspace(0.3, 1.0, num=10).tolist(),
    'reset_models': [1],
    'save_video': [0],
    'eval_episodes': [5],
}
...
_applicable_configs_continual = {'alg_name': ['continualmaxinfo'],
                             ...
                             'replay_buffer_size': [150_000], # TODO ablate
                             ...
                             'policy_reset_period': [150], # TODO ablate
                             'critic_reset_period': [150], # TODO ablate
                             'model_reset_period': [150], # TODO ablate
                            } | _applicable_configs
...
GROUP = "baseline"  # "inverted", "ant", "humanoid"
...
if GROUP == "inverted":
    ...
    all_flags_combinations = dict_permutations(configs_inverted_double_pendulum | _applicable_configs_continual_mean)
