...
PROJECT_NAME = 'MT_Jan_23_23_30_Gym_humanoid_Test_3'
WANDB_OFFLINE = True
...
_applicable_configs = {
    ...
    'pseudo_ct': [0],
    'predict_diff': [1],
    'parameter_decay':  [0.0, 0.005, 0.001, 0.0005],
    'fixed_parameter':  [5000, 5500, 6000],
    'reset_models': [1],
    'save_video': [0],
    'eval_episodes': [5],
}
...
_applicable_configs_continual = {'alg_name': ['continualmaxinfo'],
                             ...
                             'replay_buffer_size': [1_000_000], # TODO ablate
                             ...
                             'policy_reset_period': [1000], # TODO ablate
                             'critic_reset_period': [1000], # TODO ablate
                             'model_reset_period': [1000], # TODO ablate
                            } | _applicable_configs
...
all_flags_humanoid = (
    dict_permutations(configs_humanoid | _applicable_configs_continual)
  + dict_permutations(configs_humanoid | _applicable_configs_continual_mean)
)

all_flags_combinations = all_flags_humanoid
...
def main(args):
    ...
    generate_run_commands(command_list, num_cpus=args.num_cpus, num_gpus=args.num_gpus,
                          mode=args.mode, duration=f'{num_hours}:59:00', prompt=True, mem=10000)
