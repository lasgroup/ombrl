...
PROJECT_NAME = 'MT_Dez_29_20_20_MountainCar_Test_1'
...
_applicable_configs_continual = {'alg_name': ['continualmaxinfo'],
                             ...
                             'sample_model': [0],
                             'critic_real_data_update_period': [5],
                             'updates_per_step': [1], # TODO ablate
                             'init_temperature_dyn_entropy': [1.0],
                             'use_bronet': [1],
                             'env_param_mode': ['stationary', 'episodic', 'maximal', 'minimal'],
...
"""
all_flags_combinations = dict_permutations(configs_mountaincar | _applicable_configs_continual_mean)                    
