...
"""
all_flags_combinations = dict_permutations(configs_reacher | _applicable_configs_continual_mean)\
    + dict_permutations(configs_reacher | _applicable_configs_continual)             
